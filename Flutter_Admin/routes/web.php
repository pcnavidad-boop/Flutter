...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/room-bookings/{roomBooking}',             [RoomBookingController::class, 'show'])->name('room_booking.show'); // 🔧 added
    ...
    Route::get('/service-bookings/{serviceBooking}',       [ServiceBookingController::class, 'show'])->name('service_booking.show'); // 🔧 added
    ...
    Route::delete('/payments/{payment}',[PaymentController::class, 'destroy'])->name('payment.delete_data'); // will be fixed in controller
});
