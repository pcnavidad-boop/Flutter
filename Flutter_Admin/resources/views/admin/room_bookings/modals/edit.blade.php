    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content shadow">
            ...
            <div class="modal-header">
                <h5 class="modal-title fw-bold">Edit Room Booking</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="guest_name" id="edit-guest-name"
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="room_id" id="edit-room-id" class="form-select" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="number_of_guests" id="edit-guests"
                                ...
                                <div class="card border">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <button type="button" id="edit-cal-prev"
                                            ...
                                            <button type="button" id="edit-cal-next"
                                                    class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="row g-3 mt-1">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="remarks" id="edit-remarks"
